...
Vue.component('header-item', {
			...
			<div class="bry_header_wrap">
				<div class="inner clearfix">
					...
					<div class="bry_search fl">
						<input class="fl" type="text" @focus="clear" v-model="keyword1" placeholder="搜索 新闻 视频">
	...
	methods: {
		...
		headJump(num){
			if(num==1){
				window.location.href="consultation/con_message.html"
			}
			else if(num==2){
				window.location.href="consultation/con_browse.html?typeId=1"
			}
		},
		getUrl(name) {
